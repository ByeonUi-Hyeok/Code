...
INSERT INTO `news_tbl` (`id`, `title`, `originallink`, `link`, `description`, `pubDate`) VALUES
	...
	(26, '[더벨][IB 수수료 점검]NH증권, 하이브 \'유증\' 수수료 40억…역대 두번째 규모', 'http://www.thebell.co.kr/front/free/contents/news/article_view.asp?key=202106091719094640104917', 'http://www.thebell.co.kr/front/free/contents/news/article_view.asp?key=202106091719094640104917', 'NH투자증권이 하이브 유상증자 수수료로 40억원에 이르는 수익을 확보했다. NH투자증권이 유상증자로 40억원대 수수료를 수취한 것은 2011년 이후 10년만이다. 하이브는 9일 222만7848주의 신주를 발행하는 유상증자... ', 'Fri, 11 Jun 2021 12:56:00 +0900'),
	(27, '하이브·초록뱀미디어, 방탄소년단(BTS) 관련주 모두 상승세로…초록뱀미디어...', 'http://www.econonews.co.kr/news/articleView.html?idxno=203441', 'http://www.econonews.co.kr/news/articleView.html?idxno=203441', '하이브 주가흐름(그래픽=네이버금융 캡처) 방탄소년단(BTS) 관련주인 하이브와 초록뱀미디어가 상승세다. 초록뱀미디어는 11일 코스닥 시장에서 낮 12시54분 현재 전 거래일보다 0.2%(5원) 상승한 2485원에 거래... ', 'Fri, 11 Jun 2021 12:56:00 +0900'),
	(28, '북미 기업 중심 비트코인 채굴협의회 출범···일런 머스크 역할은 없다', 'https://decenter.kr/NewsView/22NLFQTV35', 'https://decenter.kr/NewsView/22NLFQTV35', '그가 공유한 BMC 공식 홈페이지에는 창립 회원으로 아르고 블록체인, 블록캡, 코어사이언티픽, 하이브 블록체인, 허트8마이닝, 마라톤 디지털 홀딩스, 마이크로스트래티지, 라이엇블록체인, 갤럭시 디지털 등... ', 'Fri, 11 Jun 2021 12:10:00 +0900'),
	(29, '방탄소년단, 데뷔일 맞아 13∼14일 온라인 팬미팅 \'소우주\'', 'http://www.incheonilbo.com/news/articleView.html?idxno=1099800', 'http://www.incheonilbo.com/news/articleView.html?idxno=1099800', '▲ /하이브 제공 방탄소년단이 데뷔일인 6월 13일을 맞아 온라인 팬 미팅을 연다. 소속사 하이브는 방탄소년단이 13일과 14일 온라인 스트리밍으로 팬 미팅 \'BTS 2021 머스터(MUSTER) 소우주\'(이하 소우주) 공연을 연다고 11일... ', 'Fri, 11 Jun 2021 10:50:00 +0900'),
	(30, '‘BTS 페스타’ 마지막은 온라인 팬미팅…13·14일 개최', 'http://www.kukinews.com/newsView/kuk202106110046', 'http://www.kukinews.com/newsView/kuk202106110046', '사진=하이브 제공. 그룹 방탄소년단이 오는 13일과 14일 온라인 팬미팅 ‘BTS 2021 머스터 소우주’를 연다. 이번 팬미팅은 방탄소년단이 데뷔 8주년을 기념해 개최한 ‘페스타(FESTA)의 마지막 행사다. 방탄소년단은 매년... ', 'Fri, 11 Jun 2021 10:30:00 +0900');
...
INSERT INTO `users_tbl` (`id`, `uid`, `upw`, `name`, `regdate`) VALUES
	(1, 'guest', '1', '게스트', '2021-06-10 10:23:41'),
	(2, 'admin', '1', '관리자', '2021-06-10 10:27:56');
